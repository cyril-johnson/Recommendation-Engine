...
class item_similarity_recommender_py():
    ...
    def generate_top_recommendations(self, user, cooccurence_matrix, all_songs, user_songs):
        ...
        #Handling the case where there are no recommendations for user
        if df.shape[0] == 0:
    ...
    def recommend(self, user):
        ...
        #Constructing item cooccurence matrix of size len(user_songs) X len(songs)
        
        cooccurence_matrix = self.construct_cooccurence_matrix(user_songs, all_songs)
        
        #Using the cooccurence matrix to make recommendations
    ...
    def get_similar_items(self, item_list):
        ...
        #Getting all unique items (songs) in the training data
        all_songs = self.get_all_items_train_data()
