...
class precision_recall_calculator():
    ...
    def random_percentage(self, list_a, percentage):
    ...
    def create_user_test_sample(self, percentage):
        ...
        self.users_test_sample = self.random_percentage(users_test_and_training, percentage)
    ...
    def get_test_sample_recommendations(self):
        ...
        #For users in user_test_sample, get top 10 recommendations from training set
    ...
    #Function to calculate all the evaluation measures
    def calculate_measures(self, percentage):
        
        #Generate a sample of users for testing recommender system
